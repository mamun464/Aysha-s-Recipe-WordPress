 ...
 */
 ...
 Class asalah_Links_Widget extends WP_Widget_Links {
...
function asalah_links_widget_register() {
    unregister_widget( 'WP_Widget_Links' );
    register_widget( 'asalah_Links_Widget' );
}
add_action( 'widgets_init', 'asalah_links_widget_register' );