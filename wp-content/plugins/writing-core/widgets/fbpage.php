...
class fbpage_widget extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        //echo '<div class="fb-page" data-href="'.$fburl.'"  '.$hide_posts.' data-width="280" data-small-header="'.$small_header.'" data-adapt-container-width="true" data-hide-cover="'.$hide_cover.'" data-show-facepile="'.$show_faces.'"><div class="fb-xfbml-parse-ignore"></div></div>';
				echo '<iframe '.$src.'="https://www.facebook.com/plugins/page.php?href='.$fburl.'&'.$hide_posts.'&width=280&small_header='.$small_header.'&adapt_container_width=true&hide_cover='.$hide_cover.'&show_facepile='.$show_faces.'&appId='.asalah_option('asalah_fb_id').'" '.$lazyclass.' width="340" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>';
        echo $after_widget;
    }
