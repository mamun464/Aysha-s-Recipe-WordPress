<?php
/*
Plugin Name: Writing Core
Plugin URI: https://ahmad.works/writing/
Description: The core plugin of Writing Wordpress theme
...
define( 'WRITING_CORE_VERSION', '1.7' );
    ...
    if (empty($consumerkey) || empty($consumersecret) || empty($accesstokensecret) || empty($accesstoken)) {
        ...
        $twitter = new pencilTwitterOAuth($consumerkey, $consumersecret, $accesstoken, $accesstokensecret);
				...
				if (asalah_option('asalah_lazyload_image_banner') == true) {
				  ...
				  $image_lazyclass = 'load_on_click ' . asalah_option('asalah_lazyload_effect');
				}
