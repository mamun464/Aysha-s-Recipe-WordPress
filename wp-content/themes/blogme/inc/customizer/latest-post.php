...
$wp_customize->add_section(
	'blogme_latest_post',
	array(
		'title' => esc_html__( 'Latest Post', 'blogme' ),
		'panel' => 'blogme_home_panel',
	)
);

$wp_customize->add_setting(
	'blogme_latest_post_title',
	array(
		'sanitize_callback' => 'sanitize_text_field',
		'default' => esc_html__( 'Latest Posts', 'blogme' ),
...
$wp_customize->add_control(
	'blogme_latest_post_title',
	array(
		'section'		=> 'blogme_latest_post',
		'label'			=> esc_html__( 'Section Title:', 'blogme' ),
		'active_callback' => 'blogme_if_latest_post_enabled'
	)
);

$wp_customize->add_setting(
	'blogme_latest_post_btn_title',
	array(
		'sanitize_callback' => 'sanitize_text_field',
...
for ($i=1; $i <= $client_num ; $i++) { 
	...
	$wp_customize->add_control(
		...
		array(
			...
			'active_callback' => 'blogme_if_latest_post_post',
			'type'			=> 'select',
