...
if ( ! class_exists( 'Blogme_Latest_Post' ) ) :

     
    class Blogme_Latest_Post extends WP_Widget {
        /**
        ...
        public function __construct() {
            $tidget_popular_post = array(
                ...
                'description' => esc_html__( 'Retrive latest posts.', 'blogme' ),
            );
            parent::__construct( 'blogme_latest_post', esc_html__( 'TO : Latest Posts', 'blogme' ), $tidget_popular_post );
        }
